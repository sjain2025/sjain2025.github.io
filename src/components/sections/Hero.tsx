      ...
      <div className="relative z-10 container mx-auto px-6 text-center flex flex-col justify-center h-full">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-20 mb-8">
            ...
            <div className="flex-shrink-0 animate-fade-up [animation-delay:0.05s]">
              <img 
                src={profileImage} 
                alt="Soham Jain" 
                className="w-60 h-60 md:w-68 md:h-68 lg:w-72 lg:h-72 xl:w-80 xl:h-80 rounded-3xl shadow-hard border-1 border-primary/55 object-cover object-center scale-[1.13]"
                loading="eager"
                decoding="async"
              />
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8 animate-fade-up [animation-delay:0.05s]">
            <Button 
              size="lg"
              className="group relative overflow-hidden primary-gradient hover:scale-105 transition-all duration-300 shadow-medium hover:shadow-hard px-10 py-6 text-lg font-semibold rounded-2xl border-2 border-primary/45 hover:border-primary/70 hover:bg-primary/15 hover:glow"
            ...
            <Button 
              size="lg"
              variant="outline"
              className="group relative overflow-hidden hover:scale-105 transition-all duration-300 px-10 py-6 text-lg font-semibold rounded-2xl border-2 border-primary/45 hover:border-primary/70 hover:bg-primary/15 backdrop-blur-sm hover:text-white"
          ...
          <div className="flex justify-center space-x-4 mb-8 animate-fade-up [animation-delay:0.05s]">
            <Button 
              variant="ghost" 
              size="icon"
              className="group relative rounded-full hover:scale-110 transition-all duration-300 hover:bg-primary/15 w-14 h-14 backdrop-blur-sm border border-primary/35 hover:border-primary/60"
              asChild
            >
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          <button 
            ...
            className="group relative animate-float hover:scale-110 transition-all duration-300 p-3 rounded-full border border-primary/35 hover:border-primary/60 backdrop-blur-sm hover:bg-primary/15"
